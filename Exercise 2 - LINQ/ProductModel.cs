    ...
    class ProductModel
    {
      ...
      public  List<Category> Categories = new List<Category>
        ...
        List<SupplierProduct> SupplierProducts = new List<SupplierProduct>
        {
            ...
            ProductID = 1, DateFirstSupplied = DateTime.Parse("12/12/2012"),
            },

             new SupplierProduct{ SupplierID = 1,
            ProductID = 2, DateFirstSupplied = DateTime.Parse("06/01/2013"),
            },

              new SupplierProduct{ SupplierID = 2,
            ProductID = 3, DateFirstSupplied = DateTime.Parse("09/09/2017"),
            },

               new SupplierProduct{ SupplierID = 2,
            ProductID = 4, DateFirstSupplied = DateTime.Parse("10/09/2017"),
            },
        };
